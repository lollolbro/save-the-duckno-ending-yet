...
scene.set_background_image(img("""
    9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
        ...
        bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
"""))
game.show_long_text("you needed food so you stole from a guy you don't know",
    DialogLayout.TOP)
game.show_long_text("he caught you so now steal the rest and run away ",
    DialogLayout.TOP)
game.show_long_text("don't lose all your hp", DialogLayout.TOP)
...
myEnemy.set_velocity(20, 20)
myEnemy.follow(mySprite, 32)
myEnemy.set_position(135, 43)
item = sprites.create(assets.image("""
    chicken
"""), SpriteKind.food)
item.set_position(randint(15, 145), randint(20, 100))
picture = 1
...
def on_forever():
    ...
    if controller.B.is_pressed():
        animation.run_image_animation(mySprite,
            ...
            100,
            False)
        mySprite.say_text("jump", 500, True)
forever(on_forever)
...
def on_forever3():
    characterAnimations.loop_frames(myEnemy,
        [img("""
                . . . . . . f f f f f f . . . . 
                        . . . . f f e e e e f 2 f . . . 
...
def on_forever4():
    global mySprite, statusbar, myEnemy, health, item, area_3
    if (health and picture) == 0:
        sprites.destroy(mySprite)
        sprites.destroy(myEnemy)
        sprites.destroy(item)
        sprites.destroy(health)
        sprites.destroy(statusbar)
        game.show_long_text("you successfully stole all his food ", DialogLayout.BOTTOM)
        game.show_long_text("so you ran away but he followed you ", DialogLayout.BOTTOM)
        scene.set_background_image(img("""
...
def on_forever5():
    if statusbar.value == 0:
        ...
        """))
        game.show_long_text("you lost too much hp", DialogLayout.BOTTOM)
forever(on_forever5)
...
def on_forever7():
    if health.value == -2:
        game.show_long_text("you got away ", DialogLayout.BOTTOM)
        sprites.destroy(mySprite)
        sprites.destroy(statusbar)
        sprites.destroy(item)
        sprites.destroy(myEnemy)
...
def on_forever8():
    if mySprite.overlaps_with(item):
        health.value += -5
        item.set_position(randint(15, 145), randint(20, 100))
forever(on_forever8)
...
def on_update_interval2():
    health.attach_to_sprite(myEnemy, 0, 0)
